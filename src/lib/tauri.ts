...
const previewProfiles: ProfileCard[] = [
  {
    folder_name: "main-office",
    display_title: "alysechencn@gmail.com",
    account_label: "alysechencn@gmail.com",
    status: "available",
    auth_present: true,
  ...
  {
    folder_name: "ai-research-sandbox",
    display_title: "AI Research Sandbox",
    account_label: "AI Research Sandbox",
    status: "available",
    auth_present: true,
    has_account_identity: true,
    plan_name: "Plus plan",
  ...
  {
    folder_name: "metadata-not-configured",
  ...
  {
    folder_name: "api-key-workspace",
    display_title: "API Key Workspace",
    account_label: "API Key Workspace",
    status: "available",
    auth_present: true,
    has_account_identity: true,
  ...
  {
    folder_name: "api-key-workspace-2",
    display_title: "API Key Workspace",
    account_label: "API Key Workspace",
    status: "available",
    auth_present: true,
...
let previewCurrentCard: CurrentCard = {
  folder_name: "primary-workspace",
  display_title: "Primary Workspace",
  account_label: "Primary Workspace",
  has_account_identity: true,
  plan_name: "Pro plan",
  subscription_days_left: 18,
  profile_folder_path: "C:/mock/primary-workspace",
};
