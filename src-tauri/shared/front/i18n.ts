...
const enMessages = {
  ...
  modelMappingCopy: "Map Codex source models to provider model names for this profile.",
  modelMappingHint: "After provider models are loaded, the right column supports dropdown suggestions and manual input.",
  modelMappingSourceLabel: "Codex model",
  modelMappingTargetLabel: "Provider model",
  modelMappingTargetPlaceholder: "Enter provider model",
  modelMappingReadModels: "Read Models",
  modelMappingAddRow: "Add Row",
  modelMappingRemoveRow: "Remove",
  modelMappingEmpty: "No mappings yet. Add a row, or save an empty list to clear mappings.",
  modelMappingDuplicateSource: "Each Codex model can only be mapped once.",
  modelMappingTargetRequired: "Provider model is required for every mapping row.",
  modelMappingMissingBaseUrl: "Set a Base Url before reading provider models.",
  modelMappingFetchedModels: "Loaded {count} provider models",
  modelMappingFetchFailed: "Failed to load provider models.",
  modelMappingProviderType: "Service provider type: {type}",
  modelMappingProviderTypeUnknown: "unknown",
  modelMappingProviderTypeResponses: "responses",
  modelMappingProviderTypeChatCompletions: "chat/completions",
  modelMappingProviderTypeMessages: "messages",
  modelMappingProviderTypeCompletions: "completions",
  ...
  profileModelReady: "Set model mappings for this profile",
  ...
  savedModelMappings: "Saved model mappings for {profile}",
  clearedModelMappings: "Cleared model mappings for {profile}",
  failedToSaveModelMappings: "Failed to save model mappings.",
...
const messages: Record<Locale, Messages> = {
  ...
  "zh-CN": {
    ...
    modelMappingCopy: "为该账号配置 Codex 源模型到第三方模型名的映射。",
    modelMappingHint: "读取到 provider 模型后，右侧列支持下拉建议，同时仍可手动输入。",
    modelMappingSourceLabel: "Codex 模型",
    modelMappingTargetLabel: "Provider 模型",
    modelMappingTargetPlaceholder: "请输入 provider 模型名",
    modelMappingReadModels: "读取模型",
    modelMappingAddRow: "新增映射",
    modelMappingRemoveRow: "移除",
    modelMappingEmpty: "当前还没有映射。可先新增一行；若保存空列表则表示清空映射。",
    modelMappingDuplicateSource: "同一个 Codex 模型只能映射一次。",
    modelMappingTargetRequired: "每一行映射都必须填写 Provider 模型。",
    modelMappingMissingBaseUrl: "请先设置 Base Url，再读取 Provider 模型。",
    modelMappingFetchedModels: "已读取 {count} 个 Provider 模型",
    modelMappingFetchFailed: "读取 Provider 模型失败。",
    modelMappingProviderType: "服务商类型：{type}",
    modelMappingProviderTypeUnknown: "未知",
    modelMappingProviderTypeResponses: "responses",
    modelMappingProviderTypeChatCompletions: "chat/completions",
    modelMappingProviderTypeMessages: "messages",
    modelMappingProviderTypeCompletions: "completions",
    ...
    savedModelMappings: "已保存 {profile} 的模型映射",
    clearedModelMappings: "已清空 {profile} 的模型映射",
    failedToSaveModelMappings: "保存模型映射失败。",
